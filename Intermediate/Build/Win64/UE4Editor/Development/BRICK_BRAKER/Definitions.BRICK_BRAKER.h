...
#define UE_PROJECT_NAME BRICK_BRAKER
#define UE_TARGET_NAME BRICK_BRAKEREditor
#define UE_MODULE_NAME "BRICK_BRAKER"
...
#define BRICK_BRAKER_API DLLEXPORT
